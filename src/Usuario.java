...
public class Usuario {
    ...
    public Usuario(String nome, String email, String telefone, String cargo, String funcao, Date dataNascimento, Double salario, Endereco endereco, Emprestimo emprestimo, Boolean administrador) {
        this.nome = nome;
        this.email = email;
